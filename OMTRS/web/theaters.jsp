            ...
            <div class="main_resize">
                ...
                <div class="content">
                    <strong>Welcome User!!!</strong> 
                            ...
                            <h2 class="star"><span>Theater list</span></h2>
                                <div class="clr"></div>
                                <ul class="sb_menu">
                                    <li class="active"><a href="#">Home</a></li>
                                    <li><a href="theaters_ragam.jsp">Ragam</a></li>
                                    <li><a href="theaters_jose.jsp">Jose</a></li>
                                    <li><a href="theaters_sapna.jsp">Sapna</a></li>
                                    <li><a href="theaters_girija.jsp">Girija</a></li>
                                </ul>
