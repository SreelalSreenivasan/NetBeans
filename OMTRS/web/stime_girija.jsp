                    ...
                    <strong>Book your show!!!</strong> 
                            ...
                            <h2 class="star"><span>Show times</span></h2>
                                ...
                                <ul class="sb_menu">
                                    ...
                                    <form name="seat_validate" action="girija_redirect.jsp" method="POST" onsubmit="return display();">
                                        <select name="stime_girija">
                                    ...
                                    <!--li><a href="girija_noon.jsp">Noon Show</a></li>
                                    <li><a href="girija_matinee.jsp">Matinee</a></li>
                                    <li><a href="girija_first.jsp">First Show</a></li>
                                    <li><a href="girija_second.jsp">Second Show</a></li-->
                                </ul>
